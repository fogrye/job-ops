...
const mapSettingsToForm = (data: AppSettings): UpdateSettingsInput => ({
  ...
  dailySearchWeekendEnabled: data.dailySearchWeekendEnabled.override,
  ...
  mailboxSyncWeekendEnabled: data.mailboxSyncWeekendEnabled.override,
...
const getDerivedSettings = (settings: AppSettings | null) => {
  ...
  return {
    ...
    scheduler: {
      ...
      dailySearchWeekendEnabled: {
        effective: settings?.dailySearchWeekendEnabled?.value ?? true,
        default: settings?.dailySearchWeekendEnabled?.default ?? true,
      },
      dailySearchPresetId: {
      ...
      mailboxSyncWeekendEnabled: {
        effective: settings?.mailboxSyncWeekendEnabled?.value ?? true,
        default: settings?.mailboxSyncWeekendEnabled?.default ?? true,
      },
    },
    scoring: {
      penalizeMissingSalary: {
