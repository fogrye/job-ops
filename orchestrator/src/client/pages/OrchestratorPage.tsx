  ...
  return (
    <>
      <OrchestratorHeader
        ...
        onOpenClosedJobs={navigation.openClosedJobs}
      />
      ...
      <main
        className={
          isSearchComposerVisible
            ...
            : "container mx-auto flex flex-col space-y-6 px-4 py-6 pb-12 lg:h-[calc(100dvh-4.3125rem)] lg:min-h-0 lg:overflow-hidden"
        }
      >
        {isSearchComposerVisible ? (
